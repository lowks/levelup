...
/* Command for C compiler:
   clang -c  -w  -I/Users/lowks/.asdf/installs/nim/v0.18.0/lib -o /Users/lowks/exercism/nim/bob/nimcache/stdlib_strutils.o /Users/lowks/exercism/nim/bob/nimcache/stdlib_strutils.c */
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsAlphaAsciiStr)(NimStringDesc* s);
...
101}
;
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_24, "\0120 < len(sep) ", 14);
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitString)(NimStringDesc* s, NimStringDesc* sep, NI maxsplit) {
	...
	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*)0;
	{
		...
		raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_24));
	}
	LA3_: ;
	result = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) newSeq((&NTI_sM4lkSb7zS6F7OVMvW9cffQ_), 0);
	{
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(230, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_26 = subInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_26), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(2048, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_27 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_27);
			} LA3: ;
		}
	}
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToUpperStr)(NimStringDesc* s) {
	...
	result = (NimStringDesc*)0;
	nimln_(366, "strutils.nim");
	nimln_(373, "strutils.nim");
	...
	result = NIM_TRUE;
	{
		...
		L = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_28 = addInt(i, ((NI) 1));
				i = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_28);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsAlphaAsciiChar)(NIM_CHAR c) {
	NIM_BOOL result;
	nimfr_("isAlphaAscii", "strutils.nim");
{	result = (NIM_BOOL)0;
	nimln_(74, "strutils.nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsAlphaAsciiStr)(NimStringDesc* s) {
	...
	nimfr_("isAlphaAscii", "strutils.nim");
{	result = (NIM_BOOL)0;
	nimln_(117, "strutils.nim");
	{
		if (!((s ? s->Sup.len : 0) == ((NI) 0))) goto LA3_;
		nimln_(118, "strutils.nim");
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA3_: ;
	nimln_(120, "strutils.nim");
	result = NIM_TRUE;
	{
		NIM_CHAR c;
		NI i;
		...
		L = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				c = s->data[i];
				nimln_(122, "strutils.nim");
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = nsuIsAlphaAsciiChar(c);
					if (!!(T10_)) goto LA11_;
					result = NIM_FALSE;
					goto BeforeRet_;
				}
				LA11_: ;
				nimln_(3827, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_29 = addInt(i, ((NI) 1));
				i = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_29);
				nimln_(3828, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L))) goto LA15_;
					failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_20));
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsAlphaStr)(NimStringDesc* s) {
	NIM_BOOL result;
	nimfr_("isAlpha", "strutils.nim");
	result = (NIM_BOOL)0;
	nimln_(289, "strutils.nim");
	nimln_(297, "strutils.nim");
	result = nsuIsAlphaAsciiStr(s);
	popFrame();
	return result;
}
